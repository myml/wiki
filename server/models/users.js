...
module.exports = class User extends Model {
  ...
  static async processProfile({ profile, providerKey }) {
    ...
    if (_.isArray(profile.emails)) {
      ...
      const message = '请前往 https://account.deepin.org/ 绑定邮箱 | Please go to https://account.deepin.org/ to bind your email.'
  ...
  static async login (opts, context) {
    ...
    if(password){
      ...
      password = crypto.privateDecrypt(priKey, Buffer.from(opts.password, "hex")).toString()
    }
